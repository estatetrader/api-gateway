...
public abstract class AnnotatedGenericType implements GenericType {
    protected final AnnotatedElement element;

    protected AnnotatedGenericType(AnnotatedElement element) {
    ...
    public Annotation[] getAnnotations() {
        return element != null ? element.getAnnotations() : new Annotation[0];
    }
     ...
     * then the returned result is the result of calling this method
     * on the superclass with {@code
    ...
    public <T extends Annotation> T[] getAnnotationsByType(Class<T> annotationClass) {
        ...
        return element != null ? element.getAnnotationsByType(annotationClass)
            : (T[]) Array.newInstance(annotationClass, 0);
    }
    ...
    public <T extends Annotation> T getDeclaredAnnotation(Class<T> annotationClass) {
        return element != null ? element.getDeclaredAnnotation(annotationClass) : null;
    }
    ...
    public <T extends Annotation> T[] getDeclaredAnnotationsByType(Class<T> annotationClass) {
        //noinspection unchecked
        return element != null ? element.getDeclaredAnnotationsByType(annotationClass)
            : (T[]) Array.newInstance(annotationClass, 0);
    }
    ...
    public Annotation[] getDeclaredAnnotations() {
        return element != null ? element.getDeclaredAnnotations() : new Annotation[0];
    }
